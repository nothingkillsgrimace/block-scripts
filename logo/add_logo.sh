...
[#A logo]trim=60:${4},format=argb, fade=in:st=60:d=0.2:alpha=1,fade=out:st=${5}:d=0.2:alpha=1,\
colorchannelmixer=aa=0.6[#B logo transparent];\
[tv rating]trim=2:${4},format=argb, fade=in:st=2:d=0.2:alpha=1,fade=out:st=11:d=0.2:alpha=1,\
